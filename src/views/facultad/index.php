                ...
                <table class="table table-dark table-hover">
                    ...
                    <?php foreach($this->d['facultades'] as $key => $value) :?>
                        <tr >
                            ...
                            <td><?= $value['status'] ?></td>
                            <td><a href="/tesis/updateFacultad/<?= $value['facultad_id'] ?>" class="btn btn-success">Editar</a></td>
                            <td>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?= $value['facultad_id'] ?>">
                                Eliminar
                                </button>
                            </td>
                        </tr>
