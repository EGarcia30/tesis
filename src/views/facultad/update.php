...
<main id="main-content" class="create-user-container">
    ...
    <div class="container mx-auto px-3">
        ...
        <div class="form-card" style="max-width: 700px; margin: 0 auto;">
            <h1 class="form-title">Editar Facultad</h1>
            
            <form action="/tesis/updateFacultad/<?= $this->d['facultad']->getId()?>" method="post">
                <div class="form-group-custom">
                    ...
                    <div class="input-wrapper-custom">
                        ...
                        <input type="text" class="form-control-custom" name="nombre" id="nombre" value="<?= $this->d['facultad']->getName() ?>" placeholder="Ingresa el nombre completo" required>
                    </div>
                ...
                <div class="form-group-custom">
                    ...
                    <div class="input-wrapper-custom">
                        ...
                        <input type="text" class="form-control-custom" name="acronimo" id="acronimo" value="<?= $this->d['facultad']->getAcronym() ?>" placeholder="Ingresa el acrónimo" required maxlength="10">
                    </div>
                    <small class="form-text-custom">
                        <i class="fas fa-info-circle"></i>
                        Ejemplo: FICA
