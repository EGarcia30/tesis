<?php require_once __DIR__ .'/../../components/layoutExtraordinario/header.php'?>
        ...
        <div class="container-fluid mx-auto p-3 d-flex flex-column gap-4">
            ...
            <div class="card card-height">
                <div class="d-flex flex-column overflow-y-scroll">
                    ...
                    <?php require_once __DIR__ . '/../../components/formExtraordinario/extraordinario.php' ?>
                    <?php require_once __DIR__ . '/../../components/formExtraordinario/verExtraordinario.php' ?>
                </div>
            </div>
        </div>
    </div>
</main>
<?php require_once __DIR__ .'/../../components/layoutExtraordinario/footer.php' ?>