        ...
        <form action="/tesis/plan/materia/<?= $this->d['plan']->getId()?>" method="post" class="position-relative" enctype="multipart/form-data">
            ...
            <div id="materias">
                ...
                <div class="mb-3 border border-utec p-3 rounded">
                    ...
                    <?php foreach($this->d['valores'] as $key => $value) :?>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="valores[]" value="<?=$value['valor_id']?>">
                        <label class="form-check-label" for="">
                            <?=$value['valor']?>
                        </label>
                    </div>
                ...
                <div class="mb-3 border border-utec p-3 rounded">
                    <div id="contenido_asignatura" class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                class="form-control" name="contenido1[]" id="" aria-describedby="helpId">
                ...
                <div class="mb-3 border border-utec p-3 rounded">
                    <div id="criterio_evaluacion" class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                class="form-control" name="criterio1[]" id="" aria-describedby="helpId" placeholder="">
                            <small id="helpId" class="form-text text-muted">Ejemplo: 1.	Explica correctamente las fases de la solución de problemas.</small>
                            <button id="agregarCE" type="button" class="btn btn-outline-primary p-0 px-2 mt-2 rounded-5" onclick="agregarCriterioE(1)" >
                                <span class="icon profile-icon">
                                    <i class="fas fa-plus"></i>
                                </span>
                            </button>
                            <button id="eliminarCE" type="button" class="btn btn-outline-danger p-0 px-2 mt-2 rounded-5" onclick="eliminarCriterioE(1)" >
                                <span class="icon profile-icon">
                                    <i class="fas fa-minus"></i>
                                </span>
                            </button>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                class="form-control" name="Spresencial1[]" id="" aria-describedby="helpId" placeholder="">
                            <small id="helpId" class="form-text text-muted">Ejemplo: Controles de lectura.</small>
                            <button id="agregarSP" type="button" class="btn btn-outline-primary p-0 px-2 mt-2 rounded-5" onclick="agregarSpresencial(1)" >
                                <span class="icon profile-icon">
                                    <i class="fas fa-plus"></i>
                                </span>
                            </button>
                            <button id="eliminarSP" type="button" class="btn btn-outline-danger p-0 px-2 mt-2 rounded-5" onclick="eliminarSpresencial(1)" >
                                <span class="icon profile-icon">
                                    <i class="fas fa-minus"></i>
                                </span>
                            </button>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                class="form-control" name="SNopresencial1[]" id="" aria-describedby="helpId" placeholder="">
                            <small id="helpId" class="form-text text-muted">Ejemplo: Controles de lectura en línea.</small>
                            <button id="agregarSNP" type="button" class="btn btn-outline-primary p-0 px-2 mt-2 rounded-5" onclick="agregarSNopresencial(1)" >
                                <span class="icon profile-icon">
                                    <i class="fas fa-plus"></i>
                                </span>
                            </button>
                            <button id="eliminarSNP" type="button" class="btn btn-outline-danger p-0 px-2 mt-2 rounded-5" onclick="eliminarSNopresencial(1)" >
                                <span class="icon profile-icon">
                                    <i class="fas fa-minus"></i>
                                </span>
                            </button>
                ...
                <div class="mb-3">
                    <p class="text-utec h6">¿Quieres ingresar otro Criterio de evaluación(+) o eliminar(-)?</p>
                    <button type="button" class="btn btn-outline-primary p-0 px-2 mt-2 rounded-5" onclick="agregarCriterioEvaluacion()" >
                        <span class="icon profile-icon">
                            <i class="fas fa-plus"></i>
                        </span>
                    </button>
                    <button type="button" class="btn btn-outline-danger p-0 px-2 mt-2 rounded-5" onclick="eliminarCriterioEvaluacion()" >
                        <span class="icon profile-icon">
                            <i class="fas fa-minus"></i>
                        </span>
                    </button>
